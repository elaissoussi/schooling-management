...
<body>
	...
	<div class="container">
	<h1>Géstion des Professeurs</h1>
		<!-- Trigger the modal with a button -->
		<button type="button" class="btn btn-info btn-lg" data-toggle="modal"
			data-target="#myModal">Add teacher</button>
				...
				<tbody>
					<c:forEach items="${profs}" var="prof">
						<tr>
							...
							<td>${prof.lastName}</td>
							<td><a href="deleteTeacher/${prof.id}">Delete</a></td>
							<td><button class="updateUser" data-toggle="modal" data-target="#updateModal"
									value="updateTeacher/${prof.id}" >Update</button></td>
						</tr>
					</c:forEach>
				</tbody>
			</table>
